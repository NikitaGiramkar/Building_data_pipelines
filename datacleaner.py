def data_cleaner():
    ...
    df = pd.read_csv("/home/nikita/airflow/input_raw/raw_store_transactions.csv")
    ...
    os. getcwd()
    df.to_csv('/home/nikita/airflow/output_cleaned_csv/clean_store_transactions.csv', index=False)
...
def data_downloader():
    ...
    urllib.request.urlretrieve(url, '/home/nikita/airflow/input_raw/raw_store_transactions.csv', reporthook=Download_Progress)
    print ("Finished")
...
def data_machine_learning():
    ...
    df = pd.read_csv("/home/nikita/airflow/output_cleaned_csv/clean_store_transactions.csv")
    ...
    filename = '/home/nikita/airflow/output_pickle/finalized_model.pkl'
...
def data_converttoparquet():   
    import pandas as pd 
    df = pd.read_csv('/home/s/airflow/output_cleaned_csv/clean_store_transactions.csv') 
    df.to_parquet('/home/s/airflow/output_parquet/output.parquet') 
